...
const Watch = () => {
  ...
  const ALLOWED_PLAYER_HOSTS = ['superflixapi.pro','www2.superflixapi.pro','superflixapi.cyou','superflixapi.fit','superflixapi.best','superflixapi.rest','superflixapi.help','www.primevicio.lat','primevicio.lat'];
